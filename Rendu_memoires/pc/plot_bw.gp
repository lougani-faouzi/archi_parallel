...
set title "L1 cache"
plot "pc_L1.dat" u 2:xtic(1) t "Intel(R) Core(TM) i5-2520M"

set title "L2 cache"
plot "pc_L2.dat" u 2:xtic(1) t "Intel(R) Core(TM) i5-2520M"

set title "L3 cache"
plot "pc_L3.dat" u 2:xtic(1) t "Intel(R) Core(TM) i5-2520M"

set title "DRAM"
plot "pc_DRAM.dat" u 2:xtic(1) t "Intel(R) Core(TM) i5-2520M"
